...
public class MecanumDriveBase extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 2.07;
    ...
    public MecanumDriveBase(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.2, 0.2, Math.toRadians(5.0)), 0.75);
...
//        imu.write8(BNO055IMU.Register.OPR_MODE, BNO055IMU.SensorMode.CONFIG.bVal & Ox0F);
//        sleep(100);
//        imu.write8(BNO055IMU.)
